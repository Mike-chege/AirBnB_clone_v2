...
class TestDBStorage(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        if type(models.storage) == DBStorage:
            ...
            cls.amenity = Amenity(name="Swimming")
    ...
    def test_docstrings(self):
        """
        Test for checking for docstrings
        """
    ...
    def test_attributes(self):
        """
        Test for checking for attributes
        """
    ...
    def test_all(self):
        """
        Test for checking for the default all method
        """
    ...
    def test_all_cls(self):
        """
        Test for all method with specified cls
        """
    ...
    def test_save(self):
        ...
        db = MySQLdb.connect(user="hbnb_test",
                             ...
                             db="hbnb_test_db")
        cursor = db.cursor()
        cursor.execute("SELECT * FROM states WHERE BINARY name = 'New York'")
    ...
    def test_delete_none(self):
        """
        Test for the delete method with None
        """
        try:

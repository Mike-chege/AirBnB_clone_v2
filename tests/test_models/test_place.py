...
class TestPlace(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.city = City(name="Rochester", state_id=cls.state.id)
        cls.user = User(email="clone@airbnb.com", password="pycode88")
        cls.place = Place(city_id=cls.city.id, user_id=cls.user.id,
                          name="Mike")
        cls.review = Review(text="jules", place_id=cls.place.id,
                            user_id=cls.user.id)
        cls.amenity = Amenity(name="swimming", place=cls.place.id)
    ...
    def test_nullable_attributes(self):
        """
        Test for email attribute is non-nullable
        """
    ...
    def test_reviews_filestorage(self):
        """
        Test for the reviews attribute
        """
    ...
    def test_is_subclass(self):
        """
        Test to check if Place is a subclass of BaseModel
        """
    ...
    def test_two_models_are_unique(self):
        """
        Test to check if different Place instances are unique
        """
        us = Place()
    ...
    def test_init_args_kwargs(self):
        """
        Test to check initialization with args and kwargs
        """
        dt = datetime.utcnow()
    ...
    def test_save_filestorage(self):
        """
        Test for the save method with FileStorage
        """

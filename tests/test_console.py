...
class TestHBNBCommand(unittest.TestCase):
    ...
    def setUpClass(cls):
        """
        Setting up the test for the CMD interpreter
        """
        try:
    ...
    def setUp(self):
        """
        Reversing
        FileStorage objects dictionary
        """
    ...
    def test_EOF(self):
        """
        Test for checking that EOF quits
        At End Of File
        """
        with patch("sys.stdout", new=StringIO()) as f:
    ...
    def test_create_kwargs(self):
        """
        Test for the create command with kwargs
        """
        with patch("sys.stdout", new=StringIO()) as f:
    ...
    def test_destroy(self):
        """
        Test for the destroy command input
        """
        with patch("sys.stdout", new=StringIO()) as f:
    ...
    def test_z_all(self):
        """
        Test for alternate all command
        """
        with patch("sys.stdout", new=StringIO()) as f:
    ...
    def test_z_show(self):
        """
        Test for  alternate show command
        """
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_destroy(self):
        """
        Test for alternate destroy command
        """
        with patch('sys.stdout', new=StringIO()) as f:
